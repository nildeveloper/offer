...
//            Comparable<? super K> k = (Comparable<? super K>) key;  // 采用key的默认比较器
//        Entry<K,V> p = root;
//        while (p != null) {
...
//    }
//
//    // 默认使用key的自然顺序来构建有序树，所谓自然顺序，
//    // 意思是key的类型是什么，就采用该类型的compareTo方法来比较大小，决定顺序
...
//        else
//            parent.right = e;
//        fixAfterInsertion(e);  // 插入完成，执行红黑树的性质恢复操作
//        size++;
//        modCount++;
//        return null;
//    }
